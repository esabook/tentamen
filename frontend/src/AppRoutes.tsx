...
const Modul = React.lazy(() => import('./pages/modul-soal/modul/Modul'));
const PaketSoal = React.lazy(() => import('./pages/modul-soal/soal/PaketSoal'));
const ImportSoal = React.lazy(() => import('./pages/modul-soal/soal/ImportSoal'));
const DaftarSoal = React.lazy(() => import('./pages/modul-soal/soal/Soal'));
const FileManager = React.lazy(() => import('./pages/modul-soal/FileManager'));
